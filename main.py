...
#importing other file's classes
...
#Image paths in an object
IMAGE_PATHS = {
    "background": "Photos/back.png",
    "admin_icon": "Photos/ad.png",
    "user_icon": "Photos/user.png",
    "password_icon": "Photos/password.png",
    "employee_management": "Photos/mgmt1.png",
    "face_recognition": "Photos/fc.png",
    "exit": "Photos/exit.png",
    "attendance_report": "Photos/report.png",
    "photo_samples": "Photos/sample.png",
    "admin_account": "Photos/passchange.png",
    "extract_embeddings": "Photos/extract.png"
}
...
def login():
            ...
            if row == None:
                ...
                def manage_employee():
                    try:
                        ...
                        bg_photo = PhotoImage(file =IMAGE_PATHS["background"], master = first)
                        background_pic = Label(first, image = bg_photo)
                        background_pic.pack()
                        first.title("Manage Employee")
                        print("Hi Nishant Bishwakarma")
                        face = Label(first, text = "Management of Employee" , bg = "white" , fg = "black", padx = 15, pady = 15, font = ("Times New Roman", 20, "bold") ,borderwidth = 5, relief = RIDGE).place(x = 500, y = 10)
                    ...
                    ################################################################################## Table frame
                        f5 = Frame(f4, bg = "gray", borderwidth = "2", relief = SUNKEN)
                ...
                def train(): 
                    try:
                        ...
                        img3= PhotoImage(file = IMAGE_PATHS["background"], master = second)
                        ...
                        img4 = PhotoImage(file = "Photos/traindata123.png")
                        train_img2 = Label(second, image = img4)
                        train_img2.place(x = 420, y = 150)
                        def back():
                            second.destroy()   
                        backbtn = Button(second, text = 'Back', fg = 'black', bg = 'white', font = ('Times new roman', 15), height = 1, width = 7, command = back).place(x = 1260, y = 2)
                        ...
                        btn = Button(second, text = "Start Training", fg = 'white',font = ("Times new roman", 20, "bold"), command = progress, bg = "gray" )
    ...
    ######################################### Function to recognize the face
                ...
                def change():
                    ...
                    title = Label(account_frame, text = "Admin Account", font = ('times new roman', 20, 'bold') , fg = 'gray', bd = 3, relief = SUNKEN)    
                    ...
                    logo_icon = PhotoImage(file =IMAGE_PATHS["admin_icon"],master = account)
                    admin_logo = Label(account_frame, image= logo_icon, bg = 'white').place( y = 70, relwidth = 1)
                    pass_icon = PhotoImage(file = IMAGE_PATHS["password_icon"], master = account)
                    ...
                    user_icon = PhotoImage(file = IMAGE_PATHS["user_icon"], master = account)
                    ...
                    btn = Button(account_frame, text = 'Reset', font = ('times new roman', 14, 'bold'), width = 10 , bg = 'gray', command = user_change, relief = GROOVE).place(x = 240, y = 380 )
                    account.mainloop()   
                ...
                def report():
                    ...
                    report.config(bg = "gray")
                    title = Frame(report, bg = "gray", bd = "3", relief = SUNKEN )
                    title.pack(fill = BOTH)
                    title_label = Label(title, text = "Attendance Report", font = ("times new roman", 30, "bold"), fg = "white", bg = "gray")
                    title_label.pack()
                    def back():
                        report.destroy()
                    backbtn = Button(title, text = 'Back' , bg = "gray" , fg = "white", font = ("Times New Roman", 20 ,"bold"), relief = RIDGE, command = back).place(x = 1250, y = 0)
                    ...
                    search_text = StringVar()
                    ####################################### Textfill Frame 
                    text_fill = Frame(report, height = 620, width = 1350, bg= "gray", borderwidth = "3", relief = SUNKEN)
                    text_fill.place(x = 10, y = 75)
                    search_label = Label(text_fill, text = "Search By:", font = ("times new roman", 15, "bold"), bg = "gray")
                ...
                def face_embedding():
                    ...
                    if not os.path.exists(embeddings_model_file):
                        ...
                        def back():
                            fe.destroy()
                        backbtn = Button(fe, text = 'Back', fg = 'White', bg = 'gray', font = ('times new roman', 18 , 'bold'), command = back).place(x = 1250, y = 1)
                        l = len(face_pixels)
                        percent = StringVar()
                        text = StringVar()  
                        ...
                        btn = Button(fe,text="Start Extracting Embeddings",fg = 'white', font = ("Times new roman", 20, "bold"),command=lambda: start_extracting_embedding(pixels=face_pixels),bg="gray")
                ...
                bg_image = PhotoImage(file = IMAGE_PATHS["background"], master = attendance)
                ...
                ########################################## Slider Colors
                colors = ['red','gray','pink','gold2','blue','black','yellow','purple','gray']
                def faceslidercolor():
                    fg = random.choice(colors)
                    topic.config(fg = fg)
                    topic.after(30,faceslidercolor)
                manage = 'Facial Recognition Attendance System'
                ...
                photo1 = PhotoImage(file = IMAGE_PATHS["employee_management"], master = attendance)
                B1 = Button(attendance, image = photo1, text = "Employee Management",font = ("Times New Roman" , 15), fg = "black", height =230, width = 265, command = manage_employee, compound = BOTTOM )
                B1.place(x = 20, y = 100)

                photo2 = PhotoImage(file = IMAGE_PATHS["face_recognition"],  master = attendance)
                B2 = Button(attendance, image = photo2 , text = "Face Recognizer", font = ("Times new roman", 15), fg = "black", height = 230, width= 265, command = face_recognize, compound = BOTTOM )
                B2.place(x = 20, y = 400)
                photo3 = PhotoImage(file ="Photos/train1.png",  master = attendance)
                B3 =  Button(attendance , image = photo3 , text = "Train the Data" , font = ("Times new roman", 15), fg = "black" , height = 230, width= 265, command = train , compound = BOTTOM )
                B3.place(x = 360, y = 100)
                photo4 = PhotoImage(file = IMAGE_PATHS["exit"],  master = attendance )
                B4 = Button(attendance, text="Exit",image = photo4, fg = "black",font = ("Times new Roman", 15), height = 230, width = 265 , command = exit, compound = BOTTOM)
                B4.place(x =1040, y = 400)
                photo5 = PhotoImage(file = IMAGE_PATHS["attendance_report"] ,  master = attendance)
                B5 = Button(attendance, text = "Attendance Report", fg = "black", font = ("Times new roman", 15), image = photo5, height = 230, width = 265, command = report, compound = BOTTOM)
                B5.place(x = 360, y = 400)
                photo6 = PhotoImage(file = IMAGE_PATHS["photo_samples"],  master = attendance)
                B6 = Button(attendance, text = "Photo Samples" ,fg = "black", font =("Times new roman",15), image = photo6, height = 230, width = 265, command = photo_samples, compound = BOTTOM )
                B6.place(x = 700, y= 100) 
                photo7 = PhotoImage(file = IMAGE_PATHS["admin_account"], master = attendance)
                B7 = Button(attendance, text="Admin Account" ,fg = "black",font =("Times new roman",15), image = photo7, height = 230, width = 265, command = change, compound = BOTTOM )
                B7.place(x = 700, y = 400)
                photo8 = PhotoImage(file = IMAGE_PATHS["extract_embeddings"], master = attendance)
                B8 = Button(attendance, text = "Extract Embeddings", fg = "black", font = ("Times new Roman", 15), image = photo8, height = 230, width = 265,command= face_embedding, compound = BOTTOM)
...
bg_icon = PhotoImage(file = IMAGE_PATHS["background"], master = face)
background_image = Label(face, image = bg_icon)
background_image.pack()

title = Label(face, text = "Admin Login Page" , font = ("times new roman", 30, "bold"), bg = "black", fg = "white", bd = 7, relief = GROOVE) 
title.place(x = 0, y = 0, relwidth = 1)

clock = Label(face , font = ("times",20,"bold"), bg = "gray", relief = GROOVE)
clock.place(x = 1000, y= 600)
tick()
login_frame= Frame(face, bg = "gray" )
login_frame.place(x = 400, y = 200)
logo_icon = PhotoImage(file = IMAGE_PATHS["admin_icon"], master= login_frame)
logo_image = Label(login_frame, image = logo_icon, bd = 0 ).grid( row = 0, columnspan = 3 , pady = 40, padx= 40)
user_icon = PhotoImage(file = IMAGE_PATHS["user_icon"], master = login_frame)
password_icon = PhotoImage(file =IMAGE_PATHS["password_icon"], master = login_frame)
...
submit_btn = Button(login_frame, text = "Log In",width = 10, activebackground = "blue", activeforeground = "white", command = login , font = ("times new roman", 20, "bold"),relief = GROOVE, bg = "gray").grid(row = 3, column = 1, pady =25, padx = 25) 
