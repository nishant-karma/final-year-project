...
def send_mail():
    ...
    server.starttls()
    server.login('bishwakarmanishant@gmail.com','ssincorss132465')
    for email in absent_staff_emails:
        server.sendmail('bishwakarmanishant@gmail.com',
                    email,
                    'You are absent')
    ...
    msg['From'] = 'bishwakarmanishant@gmail.com'
    ...
    with smtplib.SMTP_SSL('smtp.gmail.com',465) as smtp:
        smtp.login('bishwakarmanishant@gmail.com','ssincorss132465')
...
sched.add_job(send_mail,'cron',day_of_week='mon-sun', hour=12, minute=16)
sched.start()
